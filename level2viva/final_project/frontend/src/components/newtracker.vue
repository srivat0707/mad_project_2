...
.forlabel{
 ...
 #form{margin-top: 4%;width: 530px;height: 300px;}label{font-size: 1.8em;}h1{margin-top: 40px;text-align: center;}input,textarea{margin-left: 5%;padding: 2px;font-size: 1.5em;border-radius: 20px;background-color: rgba(255, 255, 255, 0.055);}#button{margin-left: 25;font-size: 1.4em;}
</style>